# Agent guide - gazebo-kotlin

This file is the quick-reference operating contract for gazebo-kotlin. The longer
...
gazebo-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`gazebo`](./README.md). Upstream Rust is the behavioral oracle while the
